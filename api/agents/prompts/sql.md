...
# Tools Available
- `execute_readonly_sql`: To query the PostgreSQL database. Strictly use SELECT statements.
...
- Call the 'execute_readonly_sql' tool again until you get the correct result.
